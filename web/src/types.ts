...
export type NegotiationBeat = {
  delayMs: number
  event: NegotiationEvent
}

export type IncidentKind = 'traffic' | 'join' | 'leave'
...
export type FlowStep = 'demand' | 'parse' | 'routes' | 'negotiate' | 'pay' | 'track'